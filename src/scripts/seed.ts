...
const seedHome = async () => {
  ...
  const home = new HomeModel({
    ...
    testimonials: [
      {
        testifier: 'GINSUI KANSHA INC',
        title: 'Ms. Leonora Lagasa - Operation Manager',
      ...
      {
        testifier: 'EKITE ELECTRONIC BICYCLE TRADING',
        title: 'Ms. Ma Katrina Malvar - Operation Manager',
